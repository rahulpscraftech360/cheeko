...
export const Section = (): JSX.Element => {
  return (
    ...
    >
      ...
      <img
  className="absolute w-[200px] h-[300px] md:w-[280px] md:h-[420px] lg:w-[333px] lg:h-[500px] top-20 left-2 object-cover mt-20 md:mt-0"
  alt="AI toy robot on the left"
  src="/Puppy_01 1.png"
/>

<img
  className="absolute w-[220px] h-[300px] md:w-[310px] md:h-[420px] lg:w-[373px] lg:h-[500px] top-20 right-2 object-cover mt-20 md:mt-0"
